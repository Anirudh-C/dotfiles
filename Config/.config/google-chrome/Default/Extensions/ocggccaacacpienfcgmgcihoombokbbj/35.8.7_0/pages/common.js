    ...
    BRW_getAcceptLanguages(function(languagesFull){
        ...
        if(typeof callback == "function"){
            callback({ // Task #1286 (UK)
                ...
                CIS :languages.indexOf("ru") != -1 || languages.indexOf("by") != -1 || languages.indexOf("ua") != -1 || languages.indexOf("kz") != -1 || languages.indexOf("kg") != -1 || languages.indexOf("uz") != -1 || languages.indexOf("ge") != -1 || languages.indexOf("az") != -1 || languages.indexOf("md") != -1
            });
        }
    });    
}
