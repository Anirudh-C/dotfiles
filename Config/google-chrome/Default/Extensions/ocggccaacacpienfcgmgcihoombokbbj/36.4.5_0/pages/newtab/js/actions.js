...
$(function () {
    ...
    applyBottomPanelOpacity();
});

function applyBottomPanelOpacity(){
    var opacity = getBottomPanelOpacity();
...
function TakeTour(data){
        ...
        tours: {
            ...
            */
            Groups: {
                ...
                onShow  : ()=>{
                    $("#relax").removeClass('relax-always-show');
                }  
            }
        },
    },
    ...
    this.start = function(){
        ...
        if(Shown && !Shown.length){
            ...
            self.tour(Object.keys(self.state.tours)[0]);
    ...
    this.tour = function(tourName){
        ...
        if(typeof Tour.onShow == "function") Tour.onShow();
