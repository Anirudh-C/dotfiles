    ...
    setTimeout(function(){//Wait for loading
        if(isAuthEnable()){
            ...
            if(_PAGE == "newtab"){
                ...
                SYNC.autoUpdate(10 * 60e3);
            }
                        
            SYNC.listenUpdates(2 * 60 * 1000);
        }//if
    }, 650);
...
function SyncLSP(data){
    ...
    */
    ...
    this.pickUpSync = function(){
        ...
        if(progress){
            ...
            waitStart = setTimeout(function(){
                ...
                //console.info(current, progress, current == progress);
    ...
    this.syncProgress = function(status, timer){
        ...
        //console.info("sync animation", status, timer); console.trace();
