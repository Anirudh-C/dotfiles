            ...
            setTimeout(()=>{
                BRW_ajax(
                    ...
                    (success)=>{//success
                        ...
                        if(titleMatch !== null && typeof titleMatch == "object" && titleMatch[2]) title = titleMatch[2];
...
function getAutoTitle(dial, callback){
    getTitle(dial.url, function(title){
        ...
        //console.info(title, decodeEntities(title));//encodeURIComponent(title), decodeURIComponent(title));
